...
<div class="col-sm-12">
    ...
    <div class="row btntambah">
        <div class="col-sm-2">
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambah_soal">Tambah Soal</button>
        </div>
    </div>
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) : ?>
                <tr>
                    ...
                    <td><?= $row['jawaban'] ?></td>
                    <td>
                        <a href="#" onclick="edit_soal('<?= $row['id'] ?>')" class="btn btn-xs btn-warning" data-bs-toggle="modal" data-bs-target="#soal_edit">edit</a> |
